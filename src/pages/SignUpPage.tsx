  ...
  <main className='grid place-items-center h-screen w-full overflow-hidden md:px-10 px-4'>
    ...
    <section className='h-screen w-full flex flex-col justify-center items-center'>
      <form className='relative flex flex-col gap-4 items-start justify-center max-w-md w-full md:rounded-3xl rounded-xl backdrop-blur-2xl full-shadow
                       ...
                       animate-fade-in'>
        {/* Title */}
        <h1 className='md:text-3xl text-2xl font-semibold self-center'>Sign up</h1>
        <TypeAnimation
          sequence={[
            "Welcome to YapChat, Yapper!",1000,
            "Start your journey now",1000,
        ...
        <input type="text" className="grow text-sm md:text-lg" placeholder="Username" onChange={e => setUsername(e.target.value)}/>
        </label>
        ...
        <input type="text" className="grow text-sm md:text-lg" placeholder="Email" onChange={e => setEmail(e.target.value)}/>
        </label>
        ...
        <button className='flex items-center justify-center bg-black text-white p-4 rounded-2xl w-full md:mt-8 my-4' 
                ...
                disabled={isFetching}>
          {isFetching ? <span className="loading loading-dots loading-md p-0"></span> : "Sign up"}
        </button>

        <div className="flex justify-between w-full text-sm">
            <Link to="/login" className="text-gray-500 hover:text-black transition">Already have an account</Link>
