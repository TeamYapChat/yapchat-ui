...
type ChatRoomGetResponseType<T = ChatRoomType[]> =
  | SuccessResponseType<T>
  | ErrorResponseType;
type ChatRoomGetByIdResponseType<T = ChatRoomType> =
  | SuccessResponseType<T>
  | ErrorResponseType;
type ChatRoomCreateResponseType<T = string> =
  | SuccessResponseType<T>
  | ErrorResponseType;
type MessageGetResponseType = MessageGetSuccessResponseType | ErrorResponseType;
type ChatRoomLeaveResponseType<T = string> =
  | SuccessResponseType<T>
  | ErrorResponseType;
type ChatRoomInviteCodeResponseType<T = string> =
  | SuccessResponseType<T>
  | ErrorResponseType;
type ChatRoomJoinResponseType<T = string> =
  | SuccessResponseType<T>
  | ErrorResponseType;
